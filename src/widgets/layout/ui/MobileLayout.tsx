    ...
    <div className="h-screen w-full bg-[#101012] text-zinc-100 flex font-sans overflow-hidden relative">
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#141417] border-t border-zinc-800/50 z-30 px-4 pt-3 pb-2">
        <div className="grid grid-cols-[1fr_auto_1fr] items-end gap-2">
          {/* Left: Smart Lyrics Editor & Credit */}
          <div className="flex flex-col items-center gap-2 pb-1">
            ...
            <div className="flex items-center bg-zinc-900/80 rounded-lg p-0.5 border border-zinc-800/50 h-9">
              <button
            ...
            <p className="text-[9px] text-zinc-600 font-medium leading-none opacity-0">
              Sviluppato da Alex Giustizieri
            </p>
          </div>
          ...
          {/* Right: Library Organizer */}
          <div className="flex flex-col items-center gap-2 pb-1">
            <span className="text-[9px] font-bold text-zinc-500 uppercase tracking-wider leading-none">
              Library Organizer
            </span>
            <div className="flex items-center bg-zinc-900/80 rounded-full p-0.5 border border-zinc-800/50 h-9">
              <button 
